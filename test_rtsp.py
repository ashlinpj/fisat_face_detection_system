...
def test_rtsp_stream(rtsp_url):
    ...
    if frame_count >= 25:
        ...
        print(f"  You can use this stream in your application.")
        return True
    elif frame_count > 0:
        print(f"\n⚠ Stream is working but unstable")
        print(f"  Consider:")
        print(f"    - Improving network connection")
        print(f"    - Reducing stream quality")
        print(f"    - Using TCP instead of UDP")
        return True
    else:
